...
- **Loot roll frame priority text is bigger too.** The "Prio: 2nd" overlay `lootFrame.lua` adds under each loot roll entry is now `GameFontNormalLarge` instead of `GameFontNormalSmall`.
